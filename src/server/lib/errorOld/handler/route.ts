 ...
 */
export function ensureErrorStatusCode(statusCode: ContentfulStatusCode | number): ErrorReponseCode {
    ...
    console.error('Unknown status code in function ensureErrorStatusCode:', statusCode);
