...
export const TransactionTabs = ({ transaction }: TransactionTabsProps) => {
    return (
                            ...
                            <CardContent>
                                <div>
                                    ...
                                    <p className="mt-1 text-lg font-semibold">
                                        {formatCurrency(parseFloat(transaction.balance), transaction.accountCurrency || 'EUR')}
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {transaction.providerTransactionId && (
                                <div>
                                    ...
                                    <p className="mt-1 font-mono text-sm">{transaction.providerTransactionId}</p>
                                </div>
                            )}
                            {transaction.key && (
                                <div>
                                    <label className="text-sm font-medium text-muted-foreground">Deduplication Key</label>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="mt-1">{format(new Date(transaction.createdAt), 'PPP p')}</p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-muted-foreground">Updated At</label>
                                <p className="mt-1">{format(new Date(transaction.updatedAt), 'PPP p')}</p>
                            </div>
                            <div>
                            ...
                            {transaction.linkedTransactionId && (
                                <div>
                                    <label className="text-sm font-medium text-muted-foreground">Linked Transaction</label>
                                    <Link 
                            ...
                            {transaction.importFile && (
                                <div>
                                    <label className="text-sm font-medium text-muted-foreground">Import Source</label>
