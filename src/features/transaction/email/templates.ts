import { EmailConfig } from '@/server/lib/email/core/template-registry';
import {
 ...
 */
export class TransactionNotificationEmailTemplate
    implements EmailConfig<TransactionNotificationEmailData>
{
 ...
 */
export class MonthlySummaryEmailTemplate implements EmailConfig<MonthlySummaryEmailData> {
