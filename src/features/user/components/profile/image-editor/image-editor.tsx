...
import { IconRotateClockwise, IconRotate, IconZoomIn, IconZoomOut } from '@tabler/icons-react';
...
export function ImageEditor({ src, onEditChange, onProcessedImageChange }: ImageEditorProps) {
    ...
    const generateCroppedImage = useCallback(async (editData: ImageEditData) => {
        try {
            const croppedImage = await getCroppedImg(src, editData.croppedAreaPixels, editData.rotation);
            ...
            <div className="relative">
                ...
                <div className="text-center mt-2">
                    <p className="text-sm text-muted-foreground">
                        Drag to reposition • Scroll or pinch to zoom • Use controls below for more options
                    </p>
                </div>
            </div>
