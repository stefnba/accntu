...
/**
 * Renders the page header if it is provided.
 *
 * @param pageHeader - The page header to render.
 * @returns {React.ReactNode} - The page header component.
 */
const renderPageHeader = (pageHeader?: PageHeaderProps) => {
